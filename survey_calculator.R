...
count_intervals_n250 <- count_conf_n_250 %>%  
  mutate(count_lower = case_when(Grid == "250m" ~ Bca.lower * 10 * 250^2 * sampled_250_n, Grid == "100m_n" ~ Bca.lower * 10 * 100^2 * sampled_100n, Grid == "100m_s" ~ Bca.lower * 10 * 100^2 * sampled_100s)) %>%
  mutate(count_upper = case_when(Grid == "250m" ~ Bca.upper * 10 * 250^2 * sampled_250_n, Grid == "100m_n" ~ Bca.upper * 10 * 100^2 * sampled_100n, Grid == "100m_s" ~ Bca.upper * 10 * 100^2 * sampled_100s)) %>%
  mutate(total_mean = case_when(Grid == "250m" ~ Mean * 10 * 250^2*sampled_250_n, Grid == "100m_n" ~ Mean * 10 * 100^2 * sampled_100n, Grid == "100m_s" ~ Mean * 10 * 100^2 * sampled_100s))
...
count_intervals_s250 <- count_conf_s_250 %>%  
  mutate(count_lower = case_when(Grid == "250m" ~ Bca.lower * 10 * 250^2 * sampled_250_s, Grid == "100m_n" ~ Bca.lower * 10 * 100^2 * sampled_100s, Grid == "100m_s" ~ Bca.lower * 10 * 100^2 * sampled_100s)) %>%
  mutate(count_upper = case_when(Grid == "250m" ~ Bca.upper * 10 * 250^2 * sampled_250_s, Grid == "100m_n" ~ Bca.upper * 10 * 100^2 * sampled_100s, Grid == "100m_s" ~ Bca.upper * 10 * 100^2 * sampled_100s)) %>%
  mutate(total_mean = case_when(Grid == "250m" ~ Mean * 10 * 250^2*sampled_250_s, Grid == "100m_n" ~ Mean * 10 * 100^2 * sampled_100s, Grid == "100m_s" ~ Mean * 10 * 100^2 * sampled_100s))
...
# groupwise means for main survey grids, filtered to remove NAs
g_250_m <- cockle_mass %>% 
  filter(year_class %in% c("Y0Weight", "Y1Weight", "Y2Weight", "Y3Weight", "total_weight")) %>%
  filter(Grid %in% c("250m", "100m_n", "100m_s")) %>%
  filter(!is.na(mass))
...
mass_intervals_n250 <- mass_conf_n_250 %>%  
  mutate(mass_lower = case_when(Grid == "250m" ~ Bca.lower * 0.01 * 250^2 * sampled_250_n, Grid == "100m_n" ~ Bca.lower * 0.01 * 100^2 * sampled_100n, Grid == "100m_s" ~ Bca.lower * 0.01 * 100^2 * sampled_100s)) %>%
  mutate(mass_upper = case_when(Grid == "250m" ~ Bca.upper * 0.01 * 250^2 * sampled_250_n, Grid == "100m_n" ~ Bca.upper * 0.01 * 100^2 * sampled_100n, Grid == "100m_s" ~ Bca.upper * 0.01 * 100^2 * sampled_100s)) %>%
  mutate(total_mean = case_when(Grid == "250m" ~ Mean * 0.01 * 250^2*sampled_250_n, Grid == "100m_n" ~ Mean * 0.01 * 100^2 * sampled_100n, Grid == "100m_s" ~ Mean * 0.01 * 100^2 * sampled_100s))
